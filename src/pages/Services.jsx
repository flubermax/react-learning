    ...
    <div className="price">
      <div className="container">
        ...
        <div className="why__wrap">
          <WhyItem image={adaptPng} 
            imageAlt="Адаптивная верстка" 
            title="Адаптивная верстка" 
            text="Возможность комфортно просматривать сайт как на компьютере, так и на мобильных устройствах" 
          />
          <WhyItem image={techPng} 
